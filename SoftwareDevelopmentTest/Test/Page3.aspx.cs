...
namespace SoftwareDevelopmentTest.Test
{
    public partial class Page3 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            XmlNode unitQuestions = questionDocument.SelectSingleNode("//questions/Unit[@Name='General Software Development']");
            ...
            for (int i = 0; i < 5; i++)
            {
                if (Session["Unit3Questions"] == null)
                {
                    // Get random question
                    x = rand.Next(1, 11);
                ...
                {
                    int[] iQuestionList = (int[])Session["Unit3Questions"];
                ...
                else
                {
                    ...
                    label.Text = String.Format("{0}. {1}<br />", (i + 11), sQuestion);
                ...
                foreach (XmlElement ele in question.SelectSingleNode("Answers").ChildNodes)
                {
                    ...
                    if (Session["Unit3Answers"] != null)
                    {
                        try
                        {
                            string[] asUserAnswers = (string[])Session["Unit3Answers"];
            ...
            if (Session["Unit3Questions"] == null)
            {
                Session.Add("Unit3Questions", questionsGot.ToArray());
            }
        }
        ...
        protected void buttonNext_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("~/Test/Results.aspx");
        }
